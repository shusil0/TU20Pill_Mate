...
public class NotificationReminderDbHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "appointmentsReminder.db";

    private static final int DATABASE_VERSION = 1;

    public NotificationReminderDbHelper(Context context) {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String SQL_CREATE_ALARM_TABLE = "CREATE TABLE " + AlarmReminderContract.AlarmReminderEntry.TABLE_NAME1 + " ("
